...
def parse_args():
    p = argparse.ArgumentParser("CIFAR-10 baseline (SGD + CE) with golden_gold exclusion + metrics jsonl only")
    ...
    p.add_argument(
        ...
        help="Where to save metrics jsonl only.",
    )
...
def main():
    ...
    print(f"[DONE] best checkpoint saved: {best_path}")
