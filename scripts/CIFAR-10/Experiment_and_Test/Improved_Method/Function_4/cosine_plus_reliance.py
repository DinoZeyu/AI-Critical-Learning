...
# Import your data module from .../Improved_Method/data_reliance.py
import sys
sys.path.append(str(Path(__file__).resolve().parents[1]))  # .../Improved_Method
from data_reliance import CifarJsonlRelianceDataset, build_transforms  # noqa: E402
...
def parse_args():
    p = argparse.ArgumentParser("v6: cosine + reliance (per-batch dynamic lr)")
    ...
    # Save
    p.add_argument("--save_dir", type=str, default="runs/cosine_plus_reliance")
    p.add_argument(
        "--metrics_dir",
        type=str,
...
def main():
    ...
    test_ds = CifarJsonlRelianceDataset(
        ...
        reliance_jsonl=None,  # test doesn't need reliance
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for x, y, r in train_loader:
            ...
            scale_t = scale_from_reliance(r_bar, args)
        ...
        row = {
            ...
            "min_lr": args.min_lr,
            "scheduler": "cosine_plus_reliance",
